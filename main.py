...
from carparkingdizz import CarParkingDizz
...
def banner(console):
    ...
    brand_name = figlet_format('MrDizz, ', font='drpepper') 
    colors = [
    ...
    console.print(f"             [bold green]𝐓𝐞𝐥𝐞𝐠𝐫𝐚𝐦 𝐁𝐎𝐓 [/bold green]: [bold cyan]@carparkingdizzbot[/bold cyan] 𝐓𝐞𝐥𝐞𝐠𝐫𝐚𝐦 [bold cyan]@carparkingdizz_tool[/bold cyan]") 
    console.print("[bold][red]==================================================================[/red][/bold]")
...
if __name__ == "__main__":
    ...
    while True:
        ...
        cpm = CarParkingDizz(acc_access_key)
